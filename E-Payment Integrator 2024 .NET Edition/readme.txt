...
E-Payment Integrator 2024 .NET Edition Usage and Deployment Instructions
...
period visit the URL below to generate a 30-day Trial Runtime License value.
    ...
    https://www.4dpayments.com/trial/DPNJA
...
Runtime License value.
    ...
    https://www.4dpayments.com/full/DPNJA
...
directory after installation:
	lib/net40/DPayments.InPay.dll
	lib/net6.0/DPayments.InPay.dll
...
library in a separate DPayments.async.InPay namespace.
...
DPayments.InPay.System.dll. This assembly implements 
...
able to provide DPayments.InPay.dll as a SAFE assembly,
suitable to run in environments with high security.

DPayments.InPay.System.dll is loaded only if necessary, 
and only if the security permissions allow it.  Note that 
distribution of  DPayments.InPay.System.dll is OPTIONAL, 
...
DPayments.InPay.Design.dll. This assembly contains functionality
